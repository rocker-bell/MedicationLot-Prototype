...
const Demo = ({ 
    ...
    useEffect(() => {
        if (userData && userData.address && signer) { // Also check for signer
    ...
    const connectAndSetup = useCallback(async () => {
        // Guard clause in case props aren't ready
    ...
    // 🟢 FIX: Add connectAndSetup and signer to the dependency array
    useEffect(() => {
